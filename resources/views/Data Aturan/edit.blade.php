...
<br><br>
    ...
    <br><br><br>
<div class="container">
	 {!! Form::model($aturan, ['url'=>route('dataaturan.update', $aturan->id_aturan), 'method'=>'put', 'class'=>'form-horizontal']) !!}
	                        {{ csrf_field() }}                       	
		<div class="row">
			<div class="col-md-5">
				...
				<div class="box box-danger">
                    ...
                    <div class="form-group{{ $errors->has('nama_aturan') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <input id="nama_aturan" type="text" class="form-control" name="nama_aturan" value="{{ $aturan->nama_aturan }}" placeholder="Masukkan nama aturan" required autofocus>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group{{ $errors->has('bun') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                ...
                                <span class="col-md-4">
                                  <input type="radio" name="bun" class="minimal-red" value="rendah" checked>
                                  Rendah
                                </span>

                                <span class="col-md-4">
                                    <input type="radio" name="bun" class="minimal-red" value="normal">
                                  Normal
                                </span>
